...
Format your response as JSON only, like this:
{
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-fuchsia-50 to-purple-50 relative overflow-hidden">
      {/* Top Navigation Bar */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-purple-500 via-indigo-500 to-fuchsia-500 nav-gradient backdrop-blur-sm bg-opacity-95">
        <div className="h-16 flex items-center justify-between px-8 max-w-7xl mx-auto relative">
          {/* Left Section */}
          <div className="w-32 flex items-center space-x-4">
            <div className="w-8 h-8 bg-white/20 rounded-lg rotate-12 floating-illustration shine-effect cursor-pointer transform hover:scale-110 transition-all duration-300">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
            <h1 className="text-2xl font-bold text-white tracking-tight flex items-center nav-logo cursor-pointer transform hover:scale-105 transition-all duration-300">
        ...
        <div className="h-0.5 bg-gradient-to-r from-purple-300 via-fuchsia-300 to-indigo-300 shine-effect"></div>
      </div>
          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            <div className="absolute inset-0 -m-8 pointer-events-none">
              ...
              <svg className="absolute -top-4 -left-4 w-24 h-24" viewBox="0 0 100 100">
                <path d="M0,50 Q25,25 50,0" stroke="url(#gradient)" strokeWidth="2" fill="none" className="opacity-50" />
                <path d="M0,20 L20,0" stroke="url(#gradient)" strokeWidth="2" fill="none" className="opacity-50" />
              </svg>
              {/* Top Right Corner */}
              <svg className="absolute -top-4 -right-4 w-24 h-24" viewBox="0 0 100 100">
                <path d="M100,50 Q75,25 50,0" stroke="url(#gradient)" strokeWidth="2" fill="none" className="opacity-50" />
                <path d="M100,20 L80,0" stroke="url(#gradient)" strokeWidth="2" fill="none" className="opacity-50" />
              </svg>
              {/* Bottom Left Corner */}
              <svg className="absolute -bottom-4 -left-4 w-24 h-24" viewBox="0 0 100 100">
                <path d="M0,50 Q25,75 50,100" stroke="url(#gradient)" strokeWidth="2" fill="none" className="opacity-50" />
                <path d="M0,80 L20,100" stroke="url(#gradient)" strokeWidth="2" fill="none" className="opacity-50" />
              </svg>
              {/* Bottom Right Corner */}
              <svg className="absolute -bottom-4 -right-4 w-24 h-24" viewBox="0 0 100 100">
                <path d="M100,50 Q75,75 50,100" stroke="url(#gradient)" strokeWidth="2" fill="none" className="opacity-50" />
                <path d="M100,80 L80,100" stroke="url(#gradient)" strokeWidth="2" fill="none" className="opacity-50" />
              </svg>
            </div>
